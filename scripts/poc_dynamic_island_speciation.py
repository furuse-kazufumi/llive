...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--period", type=int, default=8, help="migrate/merge period")
    ap.add_argument("--migrate-frac", type=float, default=0.01)
    ap.add_argument("--merge-eps", type=float, default=0.3)
