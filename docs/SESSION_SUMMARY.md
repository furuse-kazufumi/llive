...
22d2932 feat(viz): 進化の樹 (lineage tree) + 生命体 swarm — 退屈な折れ線からの脱却
4ac9e3f fix(viz): SVG 静的フォールバック — SMIL 非実行環境でも表示 (家訓)
...
19:47 scripts/evolution_genome_heatmap.py
19:46 scripts/evolution_axes_viz.py
19:46 scripts/evolution_lineage_viz.py
19:46 scripts/evolution_viz.py
```
